      ...
      <div className="container">
        <div className="promo-banner__grid">
          <div className="promo-banner__content">
            <h2 className="promo-banner__title">FORCE URBANIA</h2>
            <p className="promo-banner__subtitle">The Perfect Travel Companion</p>
            <ul className="promo-banner__features">
              <li>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                  <polyline points="20 6 9 17 4 12"/>
                </svg>
                17 Seater Comfortable Seating
              </li>
              <li>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                  <polyline points="20 6 9 17 4 12"/>
              ...
              <li>
                ...
                Ideal for Family, Group & Corporate Travel
              </li>
            </ul>
          </div>
