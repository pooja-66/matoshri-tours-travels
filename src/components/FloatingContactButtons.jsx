...
export default function FloatingContactButtons() {
  ...
  return (
    <>
      ...
      <div className="floating-contact floating-contact--left" ref={callRef}>
        <button
        ...
        {callOpen && (
          <div className="floating-contact__popup" role="dialog" aria-label="Select a phone number">
            {CALL_NUMBERS.map((item) => (
              <a key={item.tel} href={item.tel} className="floating-contact__popup-item">
      ...
      <a
        ...
        className="floating-contact floating-contact--right"
        aria-label="Chat with Matoshri Travels on WhatsApp"
      >
        <span className="floating-contact__btn floating-contact__btn--whatsapp">
