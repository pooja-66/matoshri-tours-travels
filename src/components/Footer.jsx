        ...
        <div className="footer__grid">
          <div className="footer__brand">
            <div className="footer__logo">
              ...
              <div>
                <span className="footer__brand-name">Matoshri Tours & Travels</span>
                <span className="footer__brand-tagline">Premium Travel Solutions</span>
              </div>
            </div>
            ...
            <div className="footer__social">
              ...
              <a href={`tel:${SITE_CONFIG.phone}`} aria-label="Call">
